...
def formata(texto):
    ...
    caracteres_sem_numeros = caracteres_sem_numeros.replace('ª', '')
    caracteres_sem_numeros = caracteres_sem_numeros.replace('µ', '')
    caracteres_sem_numeros = caracteres_sem_numeros.replace('º', '')
